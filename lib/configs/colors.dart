...
const Color kBottomAppBarColor = Color.fromARGB(255, 255, 255, 255);
const Color kPrimaryColor = Color.fromARGB(255, 1, 161, 254);
const Color kSecondColor = Color.fromARGB(255, 40, 40, 50);
...
const Color kProgressBackGroundColor = Color.fromARGB(255, 255, 255, 255);
//const Color kCardColor = Color.fromARGB(255, 31, 32, 38);
const Color kCardColor = Color.fromARGB(255, 255, 255, 255);
